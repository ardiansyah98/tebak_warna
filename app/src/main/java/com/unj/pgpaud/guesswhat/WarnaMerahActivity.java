...
public class WarnaMerahActivity extends AppCompatActivity {
    ...
    private String answer = "_ _ _ _ _";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnJawab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(textView.getText().toString().equals("M E R A H")) {
                    ...
                    int x = level +1 ;
                    sharedPreference.setPreferences(WarnaMerahActivity.this, "level", x);
                    if(x <= 9 ){
